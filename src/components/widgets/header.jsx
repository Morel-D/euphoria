            ...
            <div className="container-fluid">
                <a className="navbar-brand" href="/"><img src={logo} style={{height: "45px", width: "91.6px"}}/></a>
...

                    {
                            ...
                            (   <div className="" id="navbarLarge">
                            <div className="collapse navbar-collapse" id="navbarScroll">
                                <div className="searchbar"  style={{paddingRight: "210px"}}>
                                    <HeaderTextFeild img={Search} placeholder="Search" />
                                </div>
                                <div className="d-flex" role="search">
                                    ...
                                    <div><PrimaryBtn href="/sign-in" children="Login" /> </div>      
                                    <div style={{paddingLeft: "29px"}}><SecondaryBtn href="/sign-up" children="Sign Up" /></div>
                                </div>
                            </div>
                        </div>) :
                        (
